...
export default function AboutPage() {
  return (
    <>
      <Head>
        <title>About Us - Kobac Real Estate | Founded by Ilyaas Heykal</title>
        <meta 
          name="description" 
          content="Kobac Real Estate was founded by Ilyaas Heykal. This web application was created to solve Somalia's fragmented real estate market. With number #1 marking our commitment to transformation, we're bringing transparency, trust, and efficiency to property transactions across the nation." 
        />
        <meta name="keywords" content="Kobac Real Estate, Ilyaas Heykal, Somalia real estate, fragmented market, property transactions, transparency, Mogadishu properties, real estate platform" />
        <meta property="og:title" content="About Us - Kobac Real Estate | Founded by Ilyaas Heykal" />
        <meta 
        ...
        <meta name="twitter:title" content="About Us - Kobac Real Estate" />
        <meta name="twitter:description" content="Kobac Real Estate was founded by Ilyaas Heykal. Solving Somalia's fragmented real estate market with transparency, trust, and efficiency." />
      </Head>
        ...
        <div className="max-w-4xl mx-auto">
          ...
          >
            <p className="text-base sm:text-lg text-slate-600 italic mb-4 px-2">
              Kobac Real Estate was founded by <span className="font-semibold text-slate-900">Ilyaas Heykal</span>
            </p>
            <p className="text-sm sm:text-base text-slate-600 leading-relaxed max-w-2xl mx-auto px-4">
              This web application was created to solve Somalia's fragmented real estate market. With number <span className="font-bold text-blue-600">#1</span> marking our commitment to transformation, we're bringing transparency, trust, and efficiency to property transactions across the nation.
            </p>
          </motion.div>
        </div>
      </section>
